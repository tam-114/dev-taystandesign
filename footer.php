    ...
    <div class="container footer_content">
        <div class="row flex-lg-row flex-column">
            <div class="col-lg-7 col-12">
                <h1 class="footer_h1 text-center text-lg-start py-3 py-lg-0">Let's Turn Your Ideas Into <span class="squiggly-text">Reality</span>!</h1>
            </div>
            <div class="col-lg-5 col-12 d-flex justify-content-center align-items-center">
              <div>
                <a href="/contact" class="button-secondary">Get in touch with me</a>
              </div>
            </div>
        </div>
        <hr>
        ...
        <div class="row flex-lg-row flex-column">
          ...
          <div class="col-lg-3 col-12 py-lg-0 py-4">
            ...
            <div class="footer_contact-inline">
              ...
              <a href="tel:4074349422" class="footer_contact">(407) 434-9422</a>
            </div>
            <br>
            <br>
            <div class="footer_contact-inline">
              ...
              <a href="mailto:info@taystan.design" class="footer_contact">info@taystan.design</a>
            </div>
            <br>
            <br>
            <div class="navbar-links footer-links">
