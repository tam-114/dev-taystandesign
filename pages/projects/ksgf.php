...
<div class="container">
    <div class="pb-3">
        ...
        <a href="https://ksgf.org" class="btn-secondary ps-0" aria-label="Link to the Kids Sew Genius Foundation page" nofollow>Visit the Kides Sew Genius Foundation Website <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></a>
    </div>
        ...
        <div class="col-lg-6">
            <div class="position-sticky top-0">
                <div class="">
                    ...
                    <p class="">Here's what I implemented:</p>
                    <ol type="1" class="numbered-list" start="1">
                        <li><strong>SEO Improvements</strong>:
                        <ul class="bulleted-list">
                            <li style="list-style-type:disc">Replaced all image-based text with HTML and CSS to make the content searchable and indexable.</li>
                        </ul>
                        </li>
                    </ol>
                    <ol type="1" class="numbered-list" start="2">
                        ...
                        <ul class="bulleted-list">
                            <li style="list-style-type:disc">Used the Child's Play WordPress theme to create a layout that adapts seamlessly to different screen sizes.</li>
                        </ul>
                        </li>
                    </ol>
                    <ol type="1" class="numbered-list" start="3">
                        ...
                        <ul class="bulleted-list">
                            <li style="list-style-type:disc">Added a photo gallery to showcase content visually.</li>
                        </ul>
                        <ul class="bulleted-list">
                            <li style="list-style-type:disc">Integrated donation functionality with easy-to-use payment options.</li>
                        </ul>
                        </li>
                    </ol>
                    <ol type="1" class="numbered-list" start="4">
                        ...
                        <ul class="bulleted-list">
                            <li style="list-style-type:disc">Introduced a new page structure to group related information and make navigation intuitive.</li>
                        </ul>
                        </li>
                    </ol>
                    <hr>
                    ...
                    <hr>
                    <h3 class=""><strong>Visuals</strong></h3>
                    <ul class="bulleted-list">
                        <li style="list-style-type:disc"><strong>Before</strong>: A screenshot showing the old design with stacked images and pixelated text.</li>
                    </ul>
                    <ul class="bulleted-list">
                        <li style="list-style-type:disc"><strong>After</strong>: A screenshot of the new design, highlighting the clean layout, responsive design, and added features.</li>
                    </ul>
                    <hr>
                    <h3 class=""><strong>Reflection</strong></h3>
                    <p class="">This project taught me the importance of balancing functionality and design. I learned how even small changes, like replacing images with text, can significantly impact a website's performance. Moving forward, I plan to incorporate even more interactive features, like user testimonials or live donation counters, to boost engagement further.</p>
                    </div>
                </div>
            </div>
        </div>
